...
const SizeBadge = (props) => {
  ...
  return (
    <>
      {sizeInStock === false ? (
        <div className="bg-gray-200 size-badge py-2 px-5 my-1 min-w-[25vw] lg:min-w-[10vw] max-w-[10vw] border border-gray-400 inline-flex items-center justify-center rounded-md transition-all duration-200 ease-in-out hover:cursor-not-allowed">
